...
class ProblemsControllerTest < ActionController::TestCase
  ...
  test "should create problem" do
    assert_difference('Problem.count') do
      post :create, problem: { description: @problem.description, name: @problem.name, outcome: @problem.outcome }
    end
  ...
  test "should update problem" do
    put :update, id: @problem, problem: { description: @problem.description, name: @problem.name, outcome: @problem.outcome }
    assert_redirected_to problem_path(assigns(:problem))
  end
