...
class PredictionsControllerTest < ActionController::TestCase
  ...
  test "should create prediction" do
    assert_difference('Prediction.count') do
      post :create, prediction: { body: @prediction.body, problem_id: @prediction.problem_id, username: @prediction.username }
    end
  ...
  test "should update prediction" do
    put :update, id: @prediction, prediction: { body: @prediction.body, problem_id: @prediction.problem_id, username: @prediction.username }
    assert_redirected_to prediction_path(assigns(:prediction))
  end
